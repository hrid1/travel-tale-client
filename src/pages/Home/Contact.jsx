      ...
      <section className="mb-32">
        <div className="flex justify-center">
          <div className="text-center md:max-w-xl lg:max-w-3xl">
            <TitleInfo
              title="Get in Touch"
              subtitle="We’re here to assist you with your travel needs and questions."
            ></TitleInfo>
          </div>
        </div>
        ...
        <div className="flex flex-wrap">
          <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
            ...
            <button
              type="button"
              className="mb-6 inline-block w-full rounded bg-green-400 px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-green-500"
            >
              Send
            </button>
          </form>
              ...
              <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                <div className="flex items-start">
                  <div className="shrink-0">
                    <div className="inline-block rounded-md bg-green-400-100 p-4 text-green-700">
                      <svg
